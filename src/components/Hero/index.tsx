    ...
    <section className='relative min-h-screen flex flex-col items-center justify-start px-6 md:px-12 bg-[#254f1b] text-white overflow-hidden'>
      ...
      >
        ...
        <div>
          ...
          <motion.a
            href='#projects'
            className='inline-block mt-8 px-6 py-3 bg-[#e9c0e9] text-[#292522] text-2xl font-extrabold rounded-xl mb-7 shadow transition-all hover:bg-[#d2e823] hover:text-[#1e2330] hover:shadow-lg'
          >
            See My Work
          </motion.a>
        </div>
